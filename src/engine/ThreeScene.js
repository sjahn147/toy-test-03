...
export class ThreeScene {
    ...
    this.onPointerDown = (e) => {
      ...
      if (this.pointers.size === 1) {
        ...
        this.dragStart = {
          ...
          // touch drags feel natural as "grab the world and drag it"; mouse drags
          // feel natural as "swing the camera" (the opposite sign convention).
  ...
  orbitBy(dAzimuth = 0, dElevation = 0) {
    ...
    this.elevation = clamp(this.elevation + dElevation, 0.34, 1.16);
  }
  ...
  updateCamera(dt = 0) {
    if (this.autoOrbitEnabled) {
      ...
      if (this.autoOrbitActive) this.azimuth += dt * AUTO_ORBIT_SPEED;
    }
