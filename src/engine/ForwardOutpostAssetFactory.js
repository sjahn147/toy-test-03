...
export class ForwardOutpostAssetFactory {
  ...
  base(prop) {
    ...
    const ring = new THREE.Mesh(new THREE.TorusGeometry(1.02, 0.035, 7, 30), basic(color, 0.48));
  ...
  addFrontierCamp(group, prop) {
    const hide = mat(0x71594a, 0.95);
    const tent = new THREE.Mesh(new THREE.ConeGeometry(0.64, 0.92, 4), hide);
