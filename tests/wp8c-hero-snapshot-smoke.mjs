...
const rooms = roomIds.map((id, index) => ({ id, x: index * 20, z: 0, w: 14, d: 12, tags: id === 'C14' ? ['flooded'] : [] }));
const sim = {
  time: 0,
  rooms,
  agents: [],
...
assert.ok(payload.heroes.heroes.length >= 9, 'shared HeroDefinitions registry grows in later work packages');
