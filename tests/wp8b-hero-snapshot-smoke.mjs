...
assertPlain(raw);
assert.ok(raw.heroes.heroes.length >= 6, 'shared HeroDefinitions registry grows in later work packages');
...
console.log('WP8-B hero and temporary-form serializable snapshot smoke passed');
