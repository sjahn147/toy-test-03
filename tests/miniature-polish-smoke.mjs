...
const [factory, profiles, humanoid, skeleton, creatures, exotic, weapons, phase3Equipment, orc, presentation, animator, advanced, registry, renderer, observer] = await Promise.all([
...
assert.match(advanced, /agent\.downed/);
